 ...
 */
public class MyStory_WhosStoryChoose_Backup extends ActionBarActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mystory_choose_whosstory_backup);
        getSupportActionBar().setTitle("Who's Story?");
    }

    @Override
    public void onBackPressed() {
        Intent i = new Intent(MyStory_WhosStoryChoose_Backup.this, MyStory .class);
        startActivity(i);
        finish();
        super.onBackPressed();
    }
